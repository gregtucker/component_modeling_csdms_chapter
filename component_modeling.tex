...
now, what else do i want to say about bmi? it's been adopted by usgs, deltares, escience, ... and that it's language agnostic. disadvantages: requires refactoring
